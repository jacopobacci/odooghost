...
* feat(addons): add shallow clone option for remote addons (#40) ([`7d3927a`](https://github.com/remyz17/odooghost/commit/7d3927a8ef7ef9c7e4aa01579fb3abd869980c73))
...
* chore: Update dependencies ([`5dcda37`](https://github.com/remyz17/odooghost/commit/5dcda370aadb9bc51925f6ce35065a4982eff335))

* chore: Add settings.json for vscode ([`a4805f3`](https://github.com/remyz17/odooghost/commit/a4805f30ede5a15dd42604ed8a7f3cf15516f5d1))

* chore: Update pre-commit ([`4e872cb`](https://github.com/remyz17/odooghost/commit/4e872cb186c0897a20cbda9dba0cd1bd6be68180))

### Fix

* fix(data): ensure container is started when managing stack data ([`2fad85c`](https://github.com/remyz17/odooghost/commit/2fad85c76cb0690449a60ae016902b1cd41f7dba))

* fix(dockerfile): Ensure to upgrade pip dependencies and ignore installed ones ([`cbb4bd5`](https://github.com/remyz17/odooghost/commit/cbb4bd5390a283cffe9d50da2ee89a3d5661777c))

* fix(addons): When addons is local do not  try to get git repo ([`aa4566c`](https://github.com/remyz17/odooghost/commit/aa4566c8fb93f5693a09fade67ce0703402a4fb9))

### Unknown

* 0.15.1 [skip ci]

Automatically generated by python-semantic-release ([`7a7538b`](https://github.com/remyz17/odooghost/commit/7a7538bd820f5d2537e07fb3cdf43c75e0e2b405))
...
* feat(config): add support for V19.0 (#39) ([`811fa98`](https://github.com/remyz17/odooghost/commit/811fa98f7c0b1825868f3c9cad2ae62af61c716e))

### Unknown

* 0.15.0 [skip ci]

Automatically generated by python-semantic-release ([`6185c09`](https://github.com/remyz17/odooghost/commit/6185c09a0c66cf9f16eea0b7b371321ee6a57e26))
...
* feat(addons): Handle git sumodules ([`e3a5543`](https://github.com/remyz17/odooghost/commit/e3a55433998146007f5998fd18057685c3f71f41))

### Refactor

* refactor(db): print restore database output ([`0810238`](https://github.com/remyz17/odooghost/commit/0810238a1dafd77f17e1e210fd71eee69e2f8f9d))

### Unknown

* 0.14.0 [skip ci]

Automatically generated by python-semantic-release ([`8fbae5d`](https://github.com/remyz17/odooghost/commit/8fbae5d7b00b4dc664cb2054c242bb4f391934d1))

* Merge branch &#39;main&#39; of github.com:remyz17/odooghost ([`6a620b9`](https://github.com/remyz17/odooghost/commit/6a620b952bd155c80b82041820b29b19b7e88bb6))
...
* fix(stack): Allow to use the operators &#39;&lt;&#39;, &#39;&lt;=&#39;, &#39;&gt;&#39; and &#39;&gt;=&#39; in stack Python dependencies (#38) ([`c2b6263`](https://github.com/remyz17/odooghost/commit/c2b626307bfb4474d2c04fe76f091e8a11dec4ba))

### Unknown

* 0.13.1 [skip ci]

Automatically generated by python-semantic-release ([`d708856`](https://github.com/remyz17/odooghost/commit/d7088564e29ae9248dc55f0442646b448c995d63))
...
* feat(dependencies): Add custom installations support in DependenciesConfig and Dockerfile (#37) ([`1fc721b`](https://github.com/remyz17/odooghost/commit/1fc721b067f152a8ec6e5fb38b7c6654c472f4ae))

### Unknown

* 0.13.0 [skip ci]

Automatically generated by python-semantic-release ([`6aa60f7`](https://github.com/remyz17/odooghost/commit/6aa60f73e31359e5c69a1f251fa272008e5ce97b))
...
* chore(ci): Fix workflows to use specific poetry version (#35) ([`34579a1`](https://github.com/remyz17/odooghost/commit/34579a11c38b1c424bec76534740b0ee8be287f5))

### Fix

* fix(stack): Write new stack config to context when update is done ([`3953d58`](https://github.com/remyz17/odooghost/commit/3953d58f2fe65bd608e7af9d4a32a254ba818efe))

* fix(git): Clone addons if not present on stack update ([`2471927`](https://github.com/remyz17/odooghost/commit/2471927c2d949bcfa0423b74a9f61d39a530c79b))

### Unknown

* 0.12.5 [skip ci]

Automatically generated by python-semantic-release ([`09c0b22`](https://github.com/remyz17/odooghost/commit/09c0b22ab8ee1de4b073ea69a24b6035e3657d49))

* Merge branch &#39;main&#39; of github.com:remyz17/odooghost ([`d87cdb8`](https://github.com/remyz17/odooghost/commit/d87cdb850388814fb70183e974a545ca6e99be82))
...
* fix(CI): ajust package config ([`4eb1b0b`](https://github.com/remyz17/odooghost/commit/4eb1b0b3dbbd320689a1f246da1c9e1430d9e5ff))

* fix(CI): include poetry package dist correctly ([`0d2e6e7`](https://github.com/remyz17/odooghost/commit/0d2e6e777e11199737a04f7494f2b993a2471115))

### Unknown

* 0.12.4 [skip ci]

Automatically generated by python-semantic-release ([`4732061`](https://github.com/remyz17/odooghost/commit/47320619ab618bc30399e7deb77c1bcfb27b6b02))

* Merge branch &#39;main&#39; of github.com:remyz17/odooghost ([`a239e02`](https://github.com/remyz17/odooghost/commit/a239e02395daddf8c713193424dc7ba0996eeaf5))
...
* fix(CI): update node version and use pnpm ([`a9ac1bd`](https://github.com/remyz17/odooghost/commit/a9ac1bd53d5237e7c323897171e52bd497b29101))

### Unknown

* 0.12.3 [skip ci]

Automatically generated by python-semantic-release ([`5902da2`](https://github.com/remyz17/odooghost/commit/5902da2ae97a16a08b9606eddae9f27b78a7557d))
...
* fix(Dockerfile.j2): use pip with --break-system-packages, following a… (#33) ([`a3a69a8`](https://github.com/remyz17/odooghost/commit/a3a69a8d1ec0355be2322da3465c70231f80971b))

### Unknown

* 0.12.2 [skip ci]

Automatically generated by python-semantic-release ([`7e730ce`](https://github.com/remyz17/odooghost/commit/7e730ce3ef700d51126a7a53aa2a4e13fe6a398d))
...
Automatically generated by python-semantic-release ([`a5f28f8`](https://github.com/remyz17/odooghost/commit/a5f28f8d1387c8e674cf47b8022680426be5389b))
